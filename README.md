...
Some of the step need you to install an indepent enviorenment due to potential conflicts between the tools. There is detailed information inside in directory file. 
